  ...
  <body class="drawer drawer--left">
    ...
    <main>
      <div class="flex column">
        ...
        <section
          id="mision_vision "
          class="flex column text_align_center margin_mobile_16"
        >
          <div class="width_100">
            <p
          ...
          <p class="intro_light_reg text_align_center margin_32">
            ...
            proveedor confiable y competitivo ya que adquirimos el compromiso de
            solucionar problemas en cuanto a tiempo y forma de entrega de
        ...
        <section class="flex column text_align_center">
          <div class="mision">
            ...
            <p class="font_size_16">
              ...
              calidad en el menor tiempo superando las expectativas de nuestros
              consumidores.
            </p>
          </div>
          <div class="division">
          ...
          <div class="mision">
            ...
            <p class="font_size_16">
              ...
              compromiso con nuestros clientes, distintivo de calidad y enfoque
              social.
            </p>
          </div>
        </section>
        ...
        <section id="valores" class="padding_left_10pc">
          <div class="with_100 flex row">
            <div
          ...
          <div class="flex row rwrap">
            ...
            <div class="flex column flex_center text_align_center">
              ...
              <p class="intro_book_reg">
                ...
                cantidad de productos químicos, asimismo nos preocupamos por no
                crear grandes cantidades de desperdicio de papel, para generar
                un mínimo impacto medioambiental.
              </p>
              <div class="division"></div>
              <img
                class="img_esr"
        ...
        <section
          id="corte_suaje/diseño"
          class="flex column wrap wrap_desk margin_mobile_16"
        >
          ...
          <div class="flex row rwrap">
            ...
            <div class="flex_item_50 text_align_center">
              ...
              <p class="intro_book_alt_reg center_text_box">
                ...
                un apoyo económico a través de la creación de empleos dentro de
                Grupo Pressmedia.
              </p>
              <div class="division mobile"></div>
            </div>
