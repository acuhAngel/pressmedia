    ...
    <div class="flex column margin_mobile_16">
      ...
      <section id="impresion" class="flex row rwrap flex_center">
        ...
        <div class="flex flex_center margin_left_32 flex_item_50  ">
          ...
          <div class="">
            <img class="right_gray_points desk" src="assets/img/gray_points_v.png" alt="" />
          </div>
        </div>
      ...
      <section id="corte_suaje/diseño" class="flex column wrap wrap_desk">
        <div class="flex row rwrap">
          <div class="flex_item_50">
            <img class="width_100" src="assets/img/typography-stack-paper-near-cutting-machine.jpg" alt="" />
          </div>
          <div class="flex_item_50">
            <p class="intro_black_italic_italic font_size_56 text_align_center">
              Corte y suaje
            </p>
      ...
      <section id="productos" class="margin_16">
        ...
        <div class="flex flex_center flex_">
          <div class="width_200px desk"></div>
      ...
      <section id="clientes">
        <div class="flex row flex_end">
          <p class="intro_black_italic_italic font_size_48 text_align_end margin_32">
